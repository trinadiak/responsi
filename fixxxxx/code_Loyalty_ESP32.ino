...
const char* getServerURL = "http://192.168.235.47:5000/get_data";
const char* updateServerURL = "http://192.168.235.47:5000/get_data";
...
//            Serial.println("Failed attempts reset to 0 after update.");
            commandRestart = 1; // Restart the ESP32
